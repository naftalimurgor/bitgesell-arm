# Contributing to docker-bgld-arm
...
In an effort to not repeat bugs (and break less popular features), unit tests are run on [Travis CI](https://travis-ci.org/naftalimurgor/docker-bgld-arm).  The goal of the tests are to be simple and to be placed in the `test` directory where it will be automatically run.

See [test directory](https://github.com/kylemanna/docker-bgld-arm/tree/master/test) for details.
